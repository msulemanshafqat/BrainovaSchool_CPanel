...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('about.update', @$data['about']->id) }}" enctype="multipart/form-data"
                    method="post">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                        value="{{ old('name', @$data['about']->defaultTranslate->name ?? @$data['about']->name) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="ot_fileUploader left-side mb-3">
                                        <input class="form-control" type="text" placeholder="{{ ___('common.icon') }}"
                                            readonly="" id="placeholder2">
                                        <button class="primary-btn-small-input" type="button">
                                            <label class="btn btn-lg ot-btn-primary"
                                                for="fileBrouse2">{{ ___('common.browse') }}</label>
                                            <input type="file" class="d-none form-control" name="icon"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('serial') is-invalid @enderror"
                                        name="serial" value="{{ old('serial', @$data['about']->serial) }}"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control ot-textarea @error('description') is-invalid @enderror" name="description"
                                        placeholder="{{ ___('common.Enter description') }}">{{ old('description', @$data['about']->defaultTranslate->description ?? @$data['about']->description) }}</textarea>
                                    @error('description')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
