                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label for="exampleDataList" class="form-label ">{{ ___('mainapp_language.code') }} <span
                                            class="fillable">*</span></label>
                                    <input class="form-control ot-input @error('code') is-invalid @enderror" name="code"
                                        list="datalistOptions" id="exampleDataList"
                                        placeholder="{{ ___('mainapp_language.enter_code') }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 direction-button">
                                    ...
                                    <label for="validationServer04"
                                        class="form-label">{{ ___('mainapp_language.direction') }}</label>
                                    <div class="input-check-radio">
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="custom-control-label"
                                                for="rtl_direction">{{ ___('mainapp_language.rtl') }}</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-check-radio">
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <label class="custom-control-label"
                                                for="ltr_direction">{{ ___('mainapp_language.ltr') }}</label>
                                        </div>
                                    </div>
