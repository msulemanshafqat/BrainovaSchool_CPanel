                            ...
                            @foreach (@$data['fees_assigned'] as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{ calculateDiscount(@$item->feesMaster->amount, @$item->feesDiscount->discount_percentage) + $specialDiscountValue }}
                                    </td>
                                    <td>{{ calculateTax(@$item->feesMaster->amount) }}</td>
                                    <td>{{ @$item->feesMaster->amount + calculateTax(@$item->feesMaster->amount) - calculateDiscount(@$item->feesMaster->amount, @$item->feesDiscount->discount_percentage) - $specialDiscountValue}}</td>
                                    <td>
