...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('notice-board.update', [$data['notice-board']->id]) }}" enctype="multipart/form-data"
                    method="post" id="marksheet">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('date') is-invalid @enderror" name="date"
                                        ...
                                        placeholder="{{ ___('common.date') }}"
                                        value="{{ old('date', $data['notice-board']->date) }}">
                                    @error('date')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select
                                        ...
                                        @foreach ($data['departments'] ?? [] as $id => $name)
                                            <option
                                                {{ old('department_id', @$data['notice-board']->department_id) == $id ? 'selected' : '' }}
                                                value="{{ $id }}">{{ $name }}
                                            </option>
                                        @endforeach
                                        </option>
                                    ...
                                    <div
                                        ...
                                        @foreach ($data['roles'] as $item)
                                            <div class="form-check me-3">
                                                <input class="form-check-input visible-to-checkbox"
                                                    {{ $data['notice-board']->visible_to ? (in_array($item->id, $data['notice-board']->visible_to) ? 'checked' : '') : '' }}
                                                    type="checkbox" name="visible_to[]" value="{{ $item->id }}"
                                ...
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">{{ ___('common.is_visible_web') }} ?<span
                                            class="fillable"></span></label>
                                    <div
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="is_visible_web"
                                                value="1"
                                                {{ $data['notice-board']->is_visible_web == 1 ? 'checked' : '' }}
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="is_visible_web"
                                                value="0"
                                                {{ $data['notice-board']->is_visible_web == 0 ? 'checked' : '' }}
