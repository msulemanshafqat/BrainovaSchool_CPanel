...
@section('content')
    <div class="page-content">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h4 class="bradecrumb-title mb-1"> {{ ___('common.answer_sheet') }}</h1>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">{{ ___('common.home') }}</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0)">{{ ___('common.Homework') }}</a></li>
                            <li class="breadcrumb-item"> {{ ___('common.answer_sheet') }}</li>
                        </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="routine_wrapper_body">
                            <div class="student_info_wrapper">
                                <div class="student_info_single">
                                    <span>{{___('homework.Student')}} :</span>
                                    <h5>{{$data['student'] ? $data['student']->fullname : ''}} ({{$data['student'] ? $data['student']->admission_no : ''}})</h5>
                                </div>
                                @if (@$data['homework']->subject)
                                    <div class="student_info_single">
                                        <span>{{ ___('online-examination.Subject') }} :</span>
                                        <h5>{{ @$data['homework']->subject->name }} - ({{ @$data['homework']->subject->code }})</h5>
                                    </div>
                                @endif
                                <div class="student_info_single">
                                    <span>{{ ___('online-examination.Class-Section') }} :</span>
                                    <h5>{{@$data['homework']->class->name}} - ({{@$data['homework']->section->name}})</h5>
                                </div>
                                 <div class="student_info_single">
                                    <span>{{ ___('online-examination.Mark') }} :</span>
                                    <h5>{{@$data['homework']->marks}}</h5>
                                </div>
                            </div>
                            ...
                            <div class="table-content table-basic">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="confirmation" action="{{route('homework.mark.submit')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="homework_id" value="{{@$data['homework']->id}}">
                                            <input type="hidden" name="student_id" value="{{$data['answer']->student_id}}">
                                            @foreach (@$data['homework']->examQuestions as $key=>$item)
