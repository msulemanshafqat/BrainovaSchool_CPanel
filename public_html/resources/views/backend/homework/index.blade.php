...
@section('content')
    ...
    <select id="getSections" class="class nice-select niceSelect bordered_style wide @error('class') is-invalid @enderror"
        ...
        {{-- ADDED: Null coalescing '?? []' to prevent foreach errors --}}
        @foreach ($data['classes'] ?? [] as $item)
            {{-- ADDED: Safety check to ensure the class relationship exists --}}
            @if(!empty($item->class))
                        ...
                        <table class="table table-bordered role-table">
                            ...
                            <tbody class="tbody">
                                ...
                                <tr id="row_{{ $row->id }}">
                                    ...
                                    {{-- ADDED: TITLE DISPLAY --}}
                                    <td>
                                        <strong>{{ $row->title ?? 'Standard Homework' }}</strong>
                                        @if($row->task_type === 'quiz') <span class="badge bg-info">Quiz</span> @endif
                                    </td>
                                    <td>{{ $row->date }}</td>
                                        ...
                                        <td class="action">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end ">
                                                    ...
                                                    {{-- ADDED: SAFE DROPDOWN LOGIC --}}
                                                    @if($row->task_type === 'quiz')
                                                        <li>
                                                            <a href="#" class="dropdown-item text-info" onclick="alert('Student Grading & Evaluation Panel for CSV Quizzes will be built in Phase 3!')">
                                                                <span class="icon mr-8"><i class="fa-solid fa-check-to-slot"></i></span> Grading Pending (Phase 3)
                                                            </a>
                                                        </li>
                                                    @else
                                                        {{-- Native LMS Links for Standard Homework --}}
                                                        <li>
