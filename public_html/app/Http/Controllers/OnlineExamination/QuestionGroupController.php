...
class QuestionGroupController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        if($result){
            return redirect()->route($result->is_homework == 1 ? 'homework.question-group' : 'question-group.index')->with('success', $result['message']);
        }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        if($result){
            if($result->is_homework == 1) {
                return redirect()->route('homework.question-group')->with('success', $result['message']);
            }
