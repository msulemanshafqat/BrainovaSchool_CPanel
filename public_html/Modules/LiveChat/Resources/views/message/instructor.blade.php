        ...
        <div class="row">
            ...
            <div class="col-xxl-9 col-xl-8 col-lg-6 col-md-7 col-sm-7">
                <div class="chat-body">
                        ...
                        <div class="chat-cap">
                            ...
                            <div class="user-chat-caption" id="current_user"
                                ...
                                <h5><a href="javascript:;"
                                        class="user-name">{{ request('user') == 'guardian' ? $data['user']->guardian_name : $data['user']->name }}</a>
                                </h5>
                            </div>
                        </div>
                    </div>
                    <!-- End-of Show product -->
                    <!-- MessageBox -->
                    <div class="chatBox-message " id="instractor_message_window">
                        <div class="chatShow">
                            <!-- userMessage -->
                            ...
                            <div class="sendMessage">
                                ...
                                <div class="btn-wrapper form-icon">
                                    <button class="btn-rounded2" type="submit" name="submit" id="message_sent"
                                        data-url="{{ route('instructor_livechat.store', encryptFunction($data['user']->id)) }}">{{ ___('live_chat.Send') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
