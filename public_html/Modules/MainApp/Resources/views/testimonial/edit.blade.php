            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('testimonial.index') }}">{{ ___('mainapp_testimonial.testimonials') }}</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                ...
                                placeholder="{{ ___('mainapp_common.Enter name') }}" value="{{ old('name', @$data['testimonial']->name) }}">
                            @error('name')
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control ot-input @error('position') is-invalid @enderror" name="position" type="number"
                                list="datalistOptions" id="exampleDataList"
                                placeholder="{{ ___('mainapp_common.Enter position') }}" value="{{ old('position', @$data['testimonial']->position) }}">
                            @error('position')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control ot-input @error('link') is-invalid @enderror" name="link"
                                list="datalistOptions" id="exampleDataList"
                                placeholder="{{ ___('mainapp_common.Enter link') }}" value="{{ old('link', @$data['testimonial']->link) }}">
                            @error('link')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control ot-input @error('rating') is-invalid @enderror" name="rating" type="number" min="0" max="5"
                                list="datalistOptions" id="exampleDataList"
                                placeholder="{{ ___('mainapp_common.Enter rating') }}" value="{{ old('rating', @$data['testimonial']->rating) }}">
                            @error('rating')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            aria-describedby="validationServer04Feedback">
                                <option {{ old('status', @$data['testimonial']->status) == App\Enums\Status::ACTIVE ? 'selected':'' }} value="{{ App\Enums\Status::ACTIVE }}">{{ ___('mainapp_common.active') }}</option>
                                <option {{ old('status', @$data['testimonial']->status) == App\Enums\Status::INACTIVE ? 'selected':'' }} value="{{ App\Enums\Status::INACTIVE }}">{{ ___('mainapp_common.inactive') }}
                                </option>
                            </select>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea id="summernote" class="mt-0 form-control ot-textarea @error('description') is-invalid @enderror" name="description" list="datalistOptions" id="exampleDataList"
                                    placeholder="{{ ___('mainapp_common.Enter description') }}">{{ old('description', @$data['testimonial']->description) }}</textarea>
                            @error('description')
                                <div id="validationServer04Feedback" class="invalid-feedback">
                                    {{ $message }}
                                </div>
