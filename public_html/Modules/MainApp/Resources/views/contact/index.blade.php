            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">{{ ___('mainapp_commonmainapp_commonmainapp_common.Contact List') }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ ___('mainapp_contact.Contact List') }}</h4>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered feature-table">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <th class="purchase">{{ ___('mainapp_common.message') }}</th>
                                </tr>
                            </thead>
                            <tbody class="tbody">
