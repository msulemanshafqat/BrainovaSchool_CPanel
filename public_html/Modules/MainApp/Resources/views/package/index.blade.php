            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">{{ ___('mainapp_package.Package List') }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ ___('mainapp_package.Package List') }}</h4>
                        ...
                        <table class="table table-bordered package-table">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <th class="purchase">{{ ___('mainapp_package.Payment Type') }}</th>
                                    <th class="purchase">{{ ___('mainapp_common.Price') }}</th>
                                    <th class="purchase">{{ ___('mainapp_package.Student limit') }}</th>
                                    <th class="purchase">{{ ___('mainapp_package.Staff limit') }}</th>
                                    <th class="purchase">{{ ___('mainapp_package.Duration') }}</th>
                                    <th class="purchase">{{ ___('mainapp_package.Duration number') }}</th>
                                    <th class="purchase">{{ ___('mainapp_package.Popular') }}</th>
