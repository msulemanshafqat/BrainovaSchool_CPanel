            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">{{ ___('mainapp_city.City List') }}</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ ___('mainapp_city.City List') }}</h4>
                    <a href="{{ route('city.create') }}" class="btn btn-lg ot-btn-primary">
                        ...
                        <table class="table table-bordered faq-table">
                            <thead class="thead">
                                <tr>
                                    ...
                                    <th class="purchase">{{ ___('mainapp_city.Country') }}</th>
                                    <th class="purchase">{{ ___('mainapp_city.City') }}</th>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end ">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('city.edit', $row->id) }}"><span
                                                            class="icon mr-8"><i
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0);"
                                                        onclick="delete_row('city/delete', {{ $row->id }})">
