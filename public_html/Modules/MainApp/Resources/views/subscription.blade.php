            ...
            <div class="row">
                        ...
                        <form action="{{ route('purchase-subscription.store') }}" id="subscription" method="post">
                            ...
                            <div class="row">
                                ...
                                <input type="hidden" name="package_amount"
                                    value="{{ $data['package']->price + @$data['previousDue'] }}">
                                ...
                                <input type="hidden" name="package_duration_number"
                                    value="{{ $data['package']->duration_number }}">
                                ...
                                @if ($data['subdomain_name'])
                                    ...
                                    <input type="hidden" name="sub_domain_key"
                                        value="{{ $data['school_info']->sub_domain_key }}">
                                ...
                                <div class="col-xl-12 mb_15">
                                    <div class="single_select">
                                        ...
                                        <input name="name" placeholder="{{ ___('common.Type Name') }}"
                                            onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = '{{ ___('common.Type Name') }}'"
                                            class="primary_input" required type="text"
                                            value="{{ old('name', @$data['school_info']->name) }}"
                                            {{ @$data['school_info'] ? 'disabled' : '' }}>
                                    </div>
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-xl-12 mb_15">
                                    <div class="single_select">
                                        ...
                                        <input id="sub_domain_key" name="sub_domain_key"
                                            placeholder="{{ ___('common.Enter sub domain key (0-9a-z)') }}"
                                            class="primary_input" required type="text"
                                            value="{{ old('sub_domain_key', @$data['school_info']->sub_domain_key) }}"
                                            {{ @$data['school_info'] ? 'disabled' : '' }}>
                                    </div>
                                ...
                                <div class="col-xl-6 mb_15">
                                    <div class="single_select">
                                        ...
                                        <input name="email" placeholder="{{ ___('common.Type e-mail address') }}"
                                            pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$"
                                            onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = '{{ ___('common.Type e-mail address') }}'"
                                            class="primary_input" required type="email"
                                            value="{{ old('email', @$data['school_info']->email) }}"
                                            {{ @$data['school_info'] ? 'disabled' : '' }}>
                                    </div>
                                    @if ($errors->has('email'))
                                ...
                                <div class="col-xl-6 mb_15">
                                    <div class="single_select">
                                        ...
                                        <input name="phone" placeholder="{{ ___('common.Type phone number') }}"
                                            onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = '{{ ___('common.Type phone number') }}'"
                                            class="primary_input" required
                                            value="{{ old('phone', @$data['school_info']->phone) }}"
                                            {{ @$data['school_info'] ? 'disabled' : '' }}>
                                    </div>
                                    @if ($errors->has('phone'))
                                ...
                                <div class="col-xl-6 mb_24">
                                    <label class="primary_label2" for="#">{{ ___('mainapp_schools.Country') }}
                                    </label>
                                    <select class="theme_select wide session" name="session" id="getCity"
                                ...
                                <div class="col-xl-6 mb_15">
                                    <div class="single_select">
                                        <label class="primary_label2">{{ ___('mainapp_schools.City') }}</label>
                                        <select
                                            class="theme_select wide @error('city') is-invalid @enderror niceSelect cities"
                                            name="city" id="getCity">
                                            <option value="">{{ ___('mainapp_schools.Select City') }}</option>
                                            {{-- Dynamic options should be populated based on country selection --}}
                                        </select>
                                    </div>
                                    @error('city')
                                ...
                                <div class="col-xl-12 mb_30">
                                    <div class="single_select">
                                        ...
                                        <input name="address" placeholder="{{ ___('common.Type Address') }}"
                                            onfocus="this.placeholder = ''"
                                            onblur="this.placeholder = '{{ ___('common.Type Address') }}'"
                                            class="primary_input" required type="text"
                                            value="{{ old('address', @$data['school_info']->address) }}"
                                            {{ @$data['school_info'] ? 'disabled' : '' }}>
                                    </div>
                                ...
                                @if ($data['package']->payment_type == \Modules\MainApp\Enums\PackagePaymentType::PREPAID || @$data['previousDue'] > 0)
                                    <div class="col-12">
                                        ...
                                        <div class="paypal_payment_wrapper mb_24">
                                            <p>{{ ___('common.You will be redirected to the PayPal website after submitting your order') }}
                                            </p>
                                            <div class="">
                                                <label class="primary_bulet_checkbox d-flex align-items-center gap_12">
                                                    ...
                                                    <div class="paypal_icon">
                                                        <img src="{{ asset('saas-frontend') }}/img/svg/PayPal.svg"
                                                            alt="#">
                                                    </div>
                                                </label>
                                            </div>
                                        ...
                                        <div class="pay_with_card mb_24">
                                            <div class="">
                                                <label
                                                    class="primary_bulet_checkbox d-flex mb_30 align-items-start gap_12 flex-wrap align-items-center">
                                                    <input class="radio-input" type="radio" name="payment_method"
                                                        value="Stripe" checked>
                                                    <span class="checkmark m-0"></span>
                                                    <span
                                                        class="label_name d-block">{{ ___('common.Pay with Credit Card') }}</span>
                                                    <div class="card_icon">
                                                        <img src="{{ asset('saas-frontend') }}/img/svg/card_imgs.png"
                                                            alt="#">
                                                    </div>
                                                </label>
                                            </div>
                                ...
                                <div class="col-12 d-flex gap_12 flex">
                                    @php
                                        $button = session()->has('subdomainForPackageUpgrade')
                                            ? ___('ui_element.upgrade')
                                            : ___('ui_element.confirm');
                                    @endphp
                                    @if ($data['package']->payment_type == \Modules\MainApp\Enums\PackagePaymentType::PREPAID || @$data['previousDue'] > 0)
                                        <button type="button" onclick="createToken()" class="theme_btn_blue small_btn8"
                                            id='stripe-pay-btn'>
                                            {{ $button }}
                                        </button>
                                        <button type="submit" class="theme_btn_blue small_btn8 d-none"
                                            id='paypal-pay-btn'>
                                            {{ $button }}
                                        </button>
                                    @else
                ...
                <div class="col-xl-4">
                    <div class="subscription_sidebar mb_30">
                        <div
                            class="subscription_sidebar_header d-flex justify-content-between align-items-center flex-wrap">
    ...
    <script>
        ...
        $("#getCity").on('change', function(e) {
            ...
            $.ajax({
                ...
                url: url + '/frontend/get-countries',
