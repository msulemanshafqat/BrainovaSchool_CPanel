                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('memory.index') }}">{{ ___('common.Memories') }}</a>
                        </li>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (hasPermission('memory_list'))
                        <a href="{{ route('memory.index') }}" class="btn btn-lg ot-btn-primary">
                ...
                <div class="card-body">
                    <form action="{{ route('memory.update', $memory->id) }}" class="row" method="post"
