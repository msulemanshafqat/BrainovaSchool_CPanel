            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('student-panel-forum.index') }}">{{ ___('common.Forums') }}</a>
                        </li>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ $title }}</h4>
                        <a href="{{ route('student-panel-forum.index') }}" class="btn btn-lg ot-btn-primary">
                            <span><i class="fa-solid fa-arrow-left"></i> </span>
                            <span class="">{{ ___('common.Back') }}</span>
                        </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('student-panel-forum.update', $forum->id) }}" class="row" method="post" enctype="multipart/form-data">
                        @csrf()
                        @method('put')
                        <div class="col-md-6">
