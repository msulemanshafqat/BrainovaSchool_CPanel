                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('student-panel-forum.index') }}">{{ ___('common.Forums') }}</a>
                        </li>
                ...
                <div class="card-footer">
                    <div class="comments mt-10">
                        ...
                        @foreach ($forum->comments->where('parent_id', null) as $comment)
                            @include('forums::students_forum.comment', ['comment' => $comment])
                        @endforeach
                        <form action="{{ route('student-panel-forum.comment.store') }}" method="POST"
