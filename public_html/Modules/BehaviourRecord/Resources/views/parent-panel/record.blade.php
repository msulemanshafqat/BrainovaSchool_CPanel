                                                ...
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        @if ($record->appeal)
                                                            <!-- View Appeal button -->
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('parent-panel.appeal.details', $record->appeal->id) }}">
                                                            ...
                                                            @if (!in_array($record->appeal->status, ['withdraw', 'granted']))
                                                                <li>
                                                                    <a class="dropdown-item" href="{{route('parent-panel.appeal.withdraw', $record->appeal->id)}}">
        ...
        <div class="modal fade" id="appealModal" tabindex="-1" aria-labelledby="appealModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form id="appealForm" method="POST" action="{{route('parent-panel.behaviourrecord.appeal.store')}}">
                        @csrf
