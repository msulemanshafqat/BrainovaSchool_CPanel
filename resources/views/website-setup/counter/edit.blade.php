...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('counter.update', @$data['counter']->id) }}" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('name') is-invalid @enderror" name="name"
                                        value="{{ old('name', @$data['counter']->defaultTranslate->name ?? @$data['counter']->name) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('serial') is-invalid @enderror"
                                        name="serial" value="{{ old('serial', @$data['counter']->serial) }}"
                                        list="datalistOptions" id="exampleDataList" type="number"
