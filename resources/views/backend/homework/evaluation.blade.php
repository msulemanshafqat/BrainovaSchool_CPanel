        ...
        <tbody class="tbody">
            ...
            <tr id="row_{{ @$row->student->id }}">
                ...
                <td>
                    ...
                    {{ ___('academic.homework') }} :
                    @if(count($data['homework']->examQuestions))
                        <a class="btn btn-lg ot-btn-primary radius_30px small_add_btn" href="{{ route('homework.answer.sheet',[$data['homework']->id,$row->student_id]) }}" target="_blank">
                            <i class="fa-solid fa-eye"></i>
                        </a>

                    @else
                        <a class="btn btn-lg ot-btn-primary radius_30px small_add_btn" href="{{ @globalAsset($row->homeworkStudent->homeworkUpload->path, '100X100.webp') }}" target="_blank">
                            <i class="fa-solid fa-eye"></i>
                        </a>
                    @endif
                    <br>
