                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered role-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="purchase">{{ ___('common.Start-End') }}</th>

                                        <th class="purchase">{{ ___('leave.Type') }}</th>

                                        <th class="purchase">{{ ___('common.Status') }}</th>
                                        <th class="purchase">{{ ___('common.Requested')}}</th>
                                        <th class="purchase">{{ ___('common.Approved') }}</th>
