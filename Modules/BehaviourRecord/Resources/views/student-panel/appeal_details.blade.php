    ...
    <div class="col-12">
        <div class="card ot-card">
            ...
            <div class="card-body d-flex flex-column p-3" style="height: 320px;">
                ...
                <div id="messages" class="flex-grow-1 overflow-auto mb-2" style="max-height: 250px; font-size: 0.9rem;">
                    @forelse($data['messages'] as $message)
                        ...
                        <div class="d-flex align-items-start mb-2 {{ $isCurrentUser ? 'justify-content-end' : '' }}">
                            ...
                            <div>
                                <div class="{{ $isCurrentUser ? 'ot-btn-primary text-white' : 'ot-btn-primary' }} p-2 rounded"
                                    style="max-width: 70%;">
                                    <p class="mb-1 text-white" style="line-height:1.2;">{{ $message->message }}</p>
                                    ...
                                    <hr>
                                    <span class="text-muted text-white small">{{ dateFormat($message->created_at) }} {{ timeFormat($message->created_at) }}</span>
                ...
                {{-- Message Input --}}
                <form action="{{ route('student.appeal.conversation.store') }}" method="post"
                    ...
                    <input type="text" name="message" class="form-control ot-input"
