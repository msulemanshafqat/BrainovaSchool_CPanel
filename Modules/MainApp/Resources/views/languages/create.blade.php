                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <label for="exampleDataList" class="form-label ">{{ ___('mainapp_language.code') }} <span class="fillable">*</span></label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="validationServer04" class="form-label">{{ ___('mainapp_language.flag_icon') }} <span class="fillable">*</span></label>
                            ...
                            <div class="col-md-6 direction-button">
                                ...
                                <label for="validationServer04" class="form-label">{{ ___('mainapp_language.direction') }}</label>
                                ...
                                <div class="input-check-radio">
                                    <div class="form-check d-flex align-items-center">
                                        ...
                                        <label class="custom-control-label" for="ltr_direction">{{ ___('mainapp_language.ltr') }}</label>
                                    </div>
                                </div>
