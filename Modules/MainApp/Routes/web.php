...
use Modules\MainApp\Http\Controllers\CityController;
...
if (Request::getHost() == env('APP_MAIN_APP_URL') && env('APP_SAAS')) {
    ...
    Route::middleware([
        ...
        Route::post('/frontend/get-countries',     [MainAppController::class, 'getCountries'])->name('getCountries');
        ...
        Route::group(['middleware' =>   ['auth.routes']], function () {
            ...
            Route::post('/get-countries',     [MainAppController::class, 'getCountries'])->name('getCountries');
            ...
            Route::controller(CityController::class)->prefix('city')->group(function () {
                ...
                Route::delete('/delete/{id}',   'delete')->name('city.delete');
            });
