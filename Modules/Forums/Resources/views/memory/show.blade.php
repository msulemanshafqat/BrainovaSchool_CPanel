            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('memory.index') }}">{{ ___('common.Memories') }}</a>
                        </li>
                    ...
                    <div class="memory-grid mt-3">
                        ...
                        @foreach($memory->galleries as $gallery)
                            <div class="memory-item small">
                                ...
                                <button type="button" onclick="delete_row('memories/image/delete', {{ @$gallery->id }}, true)" class="close-btn">×</button>
                            </div>
                        @endforeach
                    </div>
                </div>
