...
@section('content')
    <div class="page-content">
        ...
        <div class="col-12">
            <form action="{{ route('student-panel-forum.index') }}" method="get" id="marksheed" enctype="multipart/form-data">
        ...
        <div class="table-content table-basic mt-20">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('student-panel-forum.create') }}" class="btn btn-lg ot-btn-primary">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end ">
                                                            <li>
                                                                <a class="dropdown-item"
                                                                   href="{{ route('student-panel-forum.edit', @$row->id) }}"><span
                                                                        class="icon mr-8"><i
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                   href="{{ route('student-panel-forum.show', @$row->id) }}"><span
                                                                        class="icon mr-8"><i
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="javascript:void(0);"
                                                                   onclick="delete_row('student/forum/delete', {{ @$row->id }})">
