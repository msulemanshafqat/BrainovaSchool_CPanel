...
@section('content')
    <div class="page-content">
        ...
        <div class="col-12">
            <form action="{{ route('parent-panel-memory.index') }}" method="get" id="marksheed" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ $title }}</h4>
                        <a href="{{ route('parent-panel-memory.create') }}" class="btn btn-lg ot-btn-primary">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end ">
                                                            <li>
                                                                <a class="dropdown-item"
                                                                   href="{{ route('parent-panel-memory.edit', @$row->id) }}"><span
                                                                        class="icon mr-8"><i
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item"
                                                                   href="{{ route('parent-panel-memory.show', @$row->id) }}"><span
                                                                        class="icon mr-8"><i
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="javascript:void(0);"
                                                                   onclick="delete_row('parent/memories/delete', {{ @$row->id }})">
