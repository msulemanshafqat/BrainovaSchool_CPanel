                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('parent-panel-memory.index') }}">{{ ___('common.Memories') }}</a>
                        </li>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">{{ $title }}</h4>
                        <a href="{{ route('parent-panel-memory.index') }}" class="btn btn-lg ot-btn-primary">
                            <span><i class="fa-solid fa-arrow-left"></i> </span>
                            <span class="">{{ ___('common.Back') }}</span>
                        </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('parent-panel-memory.update', $memory->id) }}" class="row" method="post"
                        ...
                        <div class="col-md-3">
                            <label for="exampleDataList" class="form-label ">{{ ___('common.Feature Image') }}<span
                                    class="fillable">*</span></label>
                        ...
                        <div class="col-md-12 mt-20">
                            ...
                            <div class="file-upload-container">
                                ...
                                <input type="file" class="d-none" id="file-input" name="gallery_images[]" multiple
                                       accept="image/*" onchange="handleFiles(this)">
                                <span class="file-count">0 of 10</span>
                            </div>
                            <div id="file-preview" class="file-preview">
                                @foreach($memory->galleries as $gallary)
                                    <div class="file-preview-item">
                                        <img src="{{ @globalAsset($gallary->image->path) }}">
                                        <button type="button" onclick="delete_row('memories/image/delete', {{ @$gallary->id }}, true)" class="close-btn">×</button>
                                    </div>
                                @endforeach
                            </div>
